...
{
    public class WebDatabaseInitializer : DropCreateDatabaseIfModelChanges<WebContext>  // DropCreateDatabaseAlways<KZKJ.IOA.WebContext>  DropCreateDatabaseIfModelChanges<KZKJ.IOA.WebContext>
    {
        ...
        private static List<Menu> GetMenus(WebContext context)
        {
        ...
        private static List<Config> GetConfigs()
        {
            var configs = new List<Config> {
                ...
                {
                    ConfigKey = "Title",
                    ConfigValue = "KZKJ.IOA.Web - 通用权限管理框架",
                    Remark = "网站的标题"
                },
                new Config
                {
