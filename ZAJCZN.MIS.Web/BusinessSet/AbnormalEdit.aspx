<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AbnormalEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.AbnormalEdit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                <f:DropDownList ID="ddlCostType" LabelWidth="120px" LabelAlign="Right" Label="异常分类" DataTextField="EnumKey" DataValueField="EnumValue"
                                    runat="server">
                                </f:DropDownList>
                            </Items>
                        </f:FormRow>
                        <f:FormRow runat="server">
                            <Items>
                                <f:TextBox ID="txtCostName" ShowRedStar="true" LabelWidth="120px" LabelAlign="Right" runat="server" Label="异常原因名称" Required="true">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
