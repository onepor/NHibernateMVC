...
{
    public partial class AbnormalManage : PageBase
    {
        #region ViewPower
        ...
        {
            List<Tm_Enum> list = GetSystemEnumByTypeKey("YCYYLX", true);
        ...
        private void BindGrid()
        {
            ...
            {
                qryList.Add(Expression.Like("AbnormalName", qryName, MatchMode.Anywhere));
            }
            ...
            {
                qryList.Add(Expression.Eq("AbnormalType", ddlCostType.SelectedValue));
            }
            Order[] orderList = new Order[1];
            Order orderli = new Order(Grid1.SortField, Grid1.SortDirection == "ASC" ? true : false);
            orderList[0] = orderli;
            int count = 0;
            IList<Tm_Abnormal> list = Core.Container.Instance.Resolve<IServiceAbnormal>().GetPaged(qryList, orderList, Grid1.PageIndex, Grid1.PageSize, out count);
        ...
        {
            return GetSystemEnumValue("YCYYLX", state);
        }
        #endregion
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            {
                Core.Container.Instance.Resolve<IServiceAbnormal>().Delete(ID);
                BindGrid();
            }
        }
