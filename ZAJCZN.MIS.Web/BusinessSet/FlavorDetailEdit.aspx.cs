...
{
    public partial class FlavorDetailEdit : PageBase
    {
        #region ViewPower
        ...
        public void Bind()
        {
            if (InfoID > 0)
            {
                ...
                txtCode.Text = FlavorInfo.FlavorCode;
                lblPY.Text = FlavorInfo.FlavorPY;
        ...
        private void SaveItem()
        {
            ...
            FlavorInfo.FlavorCode = txtCode.Text.Trim();
            FlavorInfo.FlavorPY = GetChinesePY(txtCostName.Text.Trim());
            ...
            {
                FlavorInfo.ParentID = FlavorTypeID;
