<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FlavorDetailList.aspx.cs" Inherits="ZAJCZN.MIS.Web.FlavorDetailList" %>
            ...
            <Items>
                <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="在口味备注名称中搜索"
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新增口味备注">
                                </f:Button>
                                <f:ToolbarFill ID="ToolbarFill1" runat="server">
                                </f:ToolbarFill>
                                <f:Button ID="btnReturn" OnClick="btnReturn_Click" runat="server" Icon="arrowleft" Text="返回口味类型列表">
                                </f:Button>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="FlavorName" SortField="FlavorName" Width="250px" HeaderText="口味备注" />
                        ...
                        <f:BoundField DataField="FlavorPY" SortField="FlavorPY" Width="150px" HeaderText="拼音助记码" />
                        <f:BoundField DataField="FlavorCode" SortField="FlavorCode" Width="150px" HeaderText="数字助记码" />
                        <f:WindowField ColumnID="editField" HeaderText="编辑" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                            WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/BusinessSet/FlavorDetailEdit.aspx?id={0}"
                            Width="80px" />
