...
{
    public partial class FlavorManage : PageBase
    {
        #region ViewPower
        ...
        private void LoadData()
        {
            ...
            btnNew.OnClientClick = Window1.GetShowReference("~/BusinessSet/FlavorEdit.aspx", "新增口味类型");
        ...
        public string GetCount(string id)
        {
            ...
            {
                qryList.Add(Expression.Eq("ParentID", int.Parse(id)));
            }
            Order[] orderList = new Order[1];
            Order orderli = new Order(Grid1.SortField, Grid1.SortDirection == "ASC" ? true : false);
            orderList[0] = orderli;
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "FlavorDetail")
            {
                PageContext.Redirect("~/BusinessSet/FlavorDetailList.aspx?id=" + ID);
            }
        }
