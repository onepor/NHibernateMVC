<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="VIPPrepaidEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.VIPPrepaidEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            ShowHeader="false" Title="会员卡个人充值记录">
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField TextAlign="Center" DataField="PresentationAmount" SortField="PresentationAmount" Width="120px" HeaderText="赠送余额" />
