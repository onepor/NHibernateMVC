<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractAfterCostAdd.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractAfterCostAdd" %>
                        ...
                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="2px"
                            ...
                            <Rows>  
                                <f:FormRow ID="FormRow4" runat="server">
                                    <Items>
                                        <f:DatePicker ID="dpStartDate" LabelWidth="100px" Label="售后时间"
