<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractCostManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractCostManage" %>
                ...
                <f:Grid ID="gdHandWare" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                    ...
                    <Columns>
                        ...
                        <f:RenderField Width="100px" ColumnID="ProduceState" DataField="ProduceState" FieldType="Int"
                            HeaderText="生产状态" RendererFunction="renderState" Hidden="true">
                            <Editor>
