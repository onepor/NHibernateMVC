<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractDesignManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractDesignManage" %>
...
<body>
    <form id="form1" runat="server">
            ...
            <Items>
                <f:Panel ID="Panel2" ShowHeader="false" ShowBorder="false" Layout="Column" runat="server">
                    <Items>
                        ...
                        <f:DropDownList ID="ddlSaler" Width="200px" runat="server"
                            LabelWidth="100px" Label="销售人员" LabelAlign="Right"
                            DataTextField="EmployeeName" DataValueField="ID">
                        </f:DropDownList>
                ...
                <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:WindowField ColumnID="wfSupplierField" HeaderText="生产跟踪" TextAlign="Center" Icon="CalendarEdit" ToolTip="生产厂商信息"
                            WindowID="Window3" Title="生产跟踪" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Contract/ContractTrackManage.aspx?id={0}"
                            Width="80px" />
                        <f:WindowField ColumnID="wfCostField" HeaderText="成本录入" TextAlign="Center" Icon="Money" ToolTip="生产成本录入"
                            WindowID="Window3" Title="成本录入" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Contract/ContractCostManage.aspx?id={0}"
                            Width="80px" />
                        <f:LinkButtonField HeaderText="收\付款" TextAlign="Center" Icon="MoneyAdd" ToolTip="订单收款付款信息" CommandName="editFieldMoney" Width="70px" ColumnID="lbtnEditMoneyField" />
                        ...
                        <f:GroupField HeaderText="派工信息" TextAlign="Center">
                            <Columns>
                                ...
                                <f:TemplateField Width="80px" HeaderText="送货人员">
                                    <ItemTemplate>
                                        <asp:Label ID="Label5" runat="server" Width="80px" Text='<%# GetPerson(Eval("SendPerson").ToString()) %>'></asp:Label>
                                    </ItemTemplate>
                                </f:TemplateField>
                                <f:BoundField DataField="InstalDate" HeaderText="安装时间" Width="100px" />
                                <f:TemplateField Width="80px" HeaderText="安装人员">
                                    <ItemTemplate>
                                        <asp:Label ID="Label6" runat="server" Width="80px" Text='<%# GetPerson(Eval("InstallPerson").ToString()) %>'></asp:Label>
                                    </ItemTemplate>
                                </f:TemplateField>
                            </Columns>
                        </f:GroupField>
        ...
        <f:Window ID="Window3" CloseAction="Hide" runat="server" IsModal="true" Hidden="true"
            Target="Top" EnableResize="true" EnableMaximize="true" EnableIFrame="true" IFrameUrl="about:blank"
            Width="600px" Height="580px" OnClose="Window1_Close">
        </f:Window>
        <f:Window ID="Window4" CloseAction="Hide" runat="server" IsModal="true" Hidden="true"
            Target="Top" EnableResize="true" EnableMaximize="true" EnableIFrame="true" IFrameUrl="about:blank"
            Width="1000px" Height="580px" OnClose="Window1_Close">
        </f:Window>
    </form>
</body>
</html>
