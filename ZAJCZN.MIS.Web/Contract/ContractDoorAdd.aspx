<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractDoorAdd.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractDoorAdd" %>
                                ...
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        ...
                                        <f:DropDownList ID="ddlDirection" LabelWidth="100px" LabelAlign="Right"
                                            ...
                                            <f:ListItem Text="内左开右锁" Value="内左开右锁" />
                                            <f:ListItem Text="外左开右锁" Value="外左开右锁" />
                                            <f:ListItem Text="内右开左锁" Value="内右开左锁" />
                                            <f:ListItem Text="外右开左锁" Value="外右开左锁" />
                                        </f:DropDownList>
                                    </Items>
                                </f:FormRow>
