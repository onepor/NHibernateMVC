<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractInstallEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractInstallEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" ShowBorder="false" ShowHeader="false" runat="server">
            ...
            <Items>
                <f:GroupPanel ID="GroupPanel1" runat="server" Title="安装时间">
                    <Items>
                        <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                            ...
                            <Rows>
                                <f:FormRow ID="FormRow4" runat="server">
                                    <Items>
                                        <f:DatePicker ID="dpContractDate" LabelWidth="120px" Label="安装时间" runat="server" LabelAlign="Right"
                                            Required="true" ShowRedStar="true">
                                        </f:DatePicker>
                                        <f:DropDownList ID="ddlSaler" runat="server" DataTextField="EmployeeName" DataValueField="ID"
                                            LabelWidth="100px" LabelAlign="Right" Label="安装人员">
                                        </f:DropDownList>
                                    </Items>
                                </f:FormRow>
                            </Rows>
