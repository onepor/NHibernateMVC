<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractPayAdd.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractPayAdd" %>
                                ...
                                <f:FormRow ID="FormRow2" runat="server">
                                    <Items>
                                        <f:DropDownList ID="ddlDirection" LabelWidth="100px" LabelAlign="Right"
                                            Label="单据类型" runat="server" Required="true" ShowRedStar="true"
                                            AutoPostBack="true" OnSelectedIndexChanged="ddlDirection_SelectedIndexChanged">
                                ...
                                <f:FormRow ID="FormRow5" runat="server">
                                    <Items>
                                        <f:DropDownList ID="ddlGoodType" LabelWidth="100px" ShowRedStar="true" LabelAlign="Right"
                                            Label="付款单位" DataTextField="SuppilerName" DataValueField="SuppilerName"
                                            DataSimulateTreeLevelField="Level" Required="true" runat="server" Hidden="true">
                                        </f:DropDownList>
                                    </Items>
                                </f:FormRow>
