<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractPayApproveManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractPayApproveManage" %>
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="PayUser" HeaderText="付款对象" Width="200px" />
                        <f:BoundField DataField="PayMoney" HeaderText="金额(元)" Width="120px" />
