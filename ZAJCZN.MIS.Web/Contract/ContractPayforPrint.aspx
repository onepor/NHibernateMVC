<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractPayforPrint.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractPayforPrint" %>
        ...
        <div>
            <table>
                <tr style="border: none;">
                    <th style="width: 100%; font-size: x-large; padding-bottom: 30px; border-right-color: white;" colspan="10">重庆喜莱克家具有限公司（家喜林门）付款单</th>
                </tr>
                <tr style="border-top-style: solid; border-top-width: 2px; border-top-color: black;">
                    <td style="width: 100px;">付款方</td>
