<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractViewEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractViewEdit" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch"
            ...
            <Items>
                ...
                <f:GroupPanel ID="GroupPanel1" runat="server" Title="定单基础信息">
                    <Items>
                        <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server">
                            <Items>
                                <f:FormRow>
                                    <Items>
                                        <f:Label ID="lblOrderNo" runat="server" Label="定单号" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                        <f:Label ID="lblDate" runat="server" Label="登记日期" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow>
                                    <Items>
                                        <f:Label ID="lblProject" runat="server" Label="客户地址" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                        <f:Label ID="lblCustName" runat="server" Label="客户名称" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                        <f:Label ID="lblPhone" runat="server" Label="联系电话" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow>
                                    <Items>
