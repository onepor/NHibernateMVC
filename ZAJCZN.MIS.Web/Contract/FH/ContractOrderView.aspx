<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractOrderView.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractOrderView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch"
            BoxConfigPosition="Start" ShowHeader="false" Title="查看合同发货单">
            <Items>
                            ...
                            <Items>
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:Label ID="lblOrderNo" runat="server" Label="发货单号" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                        <f:Label ID="lblDate" runat="server" Label="发货日期" LabelAlign="Right" LabelWidth="100px" Readonly="true"></f:Label>
                                        <f:Label ID="lblAmount" runat="server" LabelAlign="Right" Label="总金额(元)" Text="0" LabelWidth="100px" Hidden="true"></f:Label>
                                        <f:Label ID="lblCar" runat="server" Label="送货车辆" LabelAlign="Right" LabelWidth="100px"></f:Label>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow>
                                    <Items>
                ...
                <f:TabStrip ID="tsDetail" CssClass="blockpanel" ShowBorder="true" TabPosition="Top"  Height="450px"
                                        ...
                                        <f:Panel ID="Panel2" Title="货物重量统计" BoxFlex="2" runat="server" MarginRight="5px"
                                            ...
                                            <Items>
                                                <f:Grid ID="gdWeightInfo" ShowBorder="true" ShowHeader="false" EnableCollapse="true" 
                                                    runat="server" DataKeyNames="ID" ClicksToEdit="1" AllowPaging="false">
                                                    <Toolbars>
                                            ...
                                            <Items>
                                                <f:Grid ID="gdCostInfo" ShowBorder="true" ShowHeader="false" EnableCollapse="true" 
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <f:BoundField DataField="OrderNumber" Width="80px" HeaderText="数量" />
                                                        <f:BoundField DataField="PayPrice" Width="100px" HeaderText="单价(元)" />
                                                        <f:BoundField DataField="CostAmount" Width="100px" HeaderText="总金额(元)" />
                                                        <f:BoundField DataField="tbRemark" Width="300px" HeaderText="总金额(元)" />
                                                    </Columns>
                                                </f:Grid>
                                            </Items>
                                        </f:Panel>
