<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractSHEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractSHEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch"
            BoxConfigPosition="Start" ShowHeader="false" Title="新增合同收货单">
            <Items>
                <f:Panel ID="GroupPanel3" runat="server" ShowHeader="false">
                    <Items>
                        <f:Toolbar ID="Toolbar2" runat="server">
                            <Items>
                                <f:Button ID="btnReturn" OnClick="btnReturn_Click" runat="server" Icon="PageBack" Text="返回收货单列表">
                                </f:Button>
                                <f:Button ID="btnCancel" OnClick="btnCancel_Click" runat="server" Icon="SystemClose" Text="取消收货单">
                                </f:Button>
                    ...
                    <Items>
                        <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server">
                            <Items>
                                ...
                                <f:FormRow>
                                    <Items>
                                        <f:TextBox ID="tbManualNO" LabelWidth="100px" LabelAlign="Right" runat="server" Label="收货单号"
                                            Required="true" ShowRedStar="true" EmptyText="自编收货单号格式：客户编号-顺序号，如0016-0125">
                                        </f:TextBox>
                                        <f:DatePicker ID="dpStartDate" Label="收货日期" runat="server" Required="true" ShowRedStar="true"
                                            LabelAlign="Right" LabelWidth="100px" DateFormatString="yyyy-MM-dd" EmptyText="请选择收货日期">
                                        </f:DatePicker>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow>
                                ...
                                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                                    ...
                                    <Toolbars>
                                        <f:Toolbar ID="Toolbar1" runat="server">
                                            <Items>
                                                <f:Button ID="btnNew" Text="选择收货物品" Icon="Add" EnablePostBack="false" runat="server">
                                                </f:Button>
                                                <f:Button ID="btnDeleteSelected" Text="删除选中行" Icon="Delete"
                                                    runat="server" OnClick="btnDeleteSelected_Click">
                                                </f:Button>
                                                <f:Label ID="lblNotice1" runat="server" ShowLabel="false" Text="点击收货数量直接填写修改实际出库数量" CssStyle="color:red;"></f:Label>
                        ...
                        <f:Tab ID="tabOtherGoods" Title="辅材赔偿明细" BodyPadding="10px" Layout="Fit" runat="server">
                            <Items>
                                <f:Grid ID="GridSecondDetail" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                                    ...
                                    EnableAfterEditEvent="true" OnAfterEdit="GridSecondDetail_AfterEdit" AllowCellEditing="true">
                                    <Columns>
                                        ...
                                        <f:BoundField DataField="MainGoodsOrderInfo.GoodsNumber" Hidden="true" Width="120px" HeaderText="主材数量" />
                                        ...
                                        <f:RenderField Width="120px" ColumnID="PayForNumber" DataField="PayForNumber" FieldType="Double"
                                            HeaderText="赔偿数量">
                                            <Editor>
                                                <f:NumberBox ID="nbPayForNumber" NoDecimal="false" NoNegative="true" MinValue="0" DecimalPrecision="3"
                                                    runat="server">
                                                </f:NumberBox>
                                            </Editor>
                                        </f:RenderField>
