<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ContractSHManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.ContractSHManage" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Panel ID="Panel2" ShowHeader="false" ShowBorder="false" Layout="Column" runat="server">
                    <Items>
                        <f:TextBox ID="txtOrderNo" runat="server" Label="查询单号" Width="300px" LabelAlign="Right" LabelWidth="80px" EmptyText="在客户名称、收货单号中搜索"></f:TextBox>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" OnClick="btnNew_Click" Text="新增收货单">
                                </f:Button>
                    ...
                    <Columns>
                        <f:WindowField ColumnID="editField" HeaderText="查看" Hidden="false" TextAlign="Center" Icon="Zoom" ToolTip="查看收货单明细"
                            WindowID="Window1" Title="查看收货单明细" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Contract/SH/ContractSHView.aspx?id={0}"
                            Width="50px" />
                        <f:LinkButtonField HeaderText="编辑" TextAlign="Center" Icon="Pencil" ToolTip="编辑收货单"
                        ...
                        <f:BoundField DataField="ManualNO" SortField="ManualNO" Width="160px" HeaderText="收货单号" />
                        <f:BoundField DataField="OrderDate" SortField="OrderDate" Width="140px" HeaderText="收货时间" DataFormatString="{0:yyyy-MM-dd}" />
