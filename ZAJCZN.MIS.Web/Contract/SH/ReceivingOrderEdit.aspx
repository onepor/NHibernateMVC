<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivingOrderEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.ReceivingOrderEdit" %>
                            ...
                            <Items>
                                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                                    ...
                                    <Columns>
                                        ...
                                        <f:BoundField DataField="FormerlyGoodsNumber" SortField="FormerlyGoodsNumber" Width="100px" HeaderText="收货数量" />
                                        ...
                                        <f:BoundField DataField="GoodsNumber" SortField="GoodsNumber" Width="100px" HeaderText="实际收货数量" />
