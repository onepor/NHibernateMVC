<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceivingOrderManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.ReceivingOrderManage" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start"
            ShowHeader="false" Title="收货管理">
            <Items>
                <f:Panel ID="Panel2" ShowHeader="false" ShowBorder="false" Layout="Column" runat="server">
                    <Items>
                        <f:TextBox ID="txtOrderNo" runat="server" Label="查询单号" Width="400px" LabelAlign="Right" LabelWidth="80px" EmptyText="在客户名称、发货单号、系统单号中搜索"></f:TextBox>
                        <f:DatePicker ID="dpStartDate" LabelWidth="120px" Label="收货起止时间" Width="260px" runat="server" LabelAlign="Right">
                        </f:DatePicker>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        <f:WindowField ColumnID="editField" HeaderText="查看" Hidden="false" TextAlign="Center" Icon="Zoom" ToolTip="查看收货单明细"
                            WindowID="Window1" Title="查看收货单明细" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Contract/SH/ReceivingOrderView.aspx?id={0}"
                            Width="50px" />
                        ...
                        <f:BoundField DataField="ManualNO" SortField="ManualNO" Width="120px" HeaderText="收货单号" />
                        ...
                        <f:BoundField DataField="OrderDate" SortField="OrderDate" Width="120px" HeaderText="收货时间" DataFormatString="{0:yyyy-MM-dd}" />
                        <f:BoundField DataField="CarNO" SortField="CarNO" Width="100px" HeaderText="送货车牌号" />
