<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="DMergePay.aspx.cs" Inherits="ZAJCZN.MIS.Web.DMergePay" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="PanelMain" CssClass="blockpanel" Margin="2px" runat="server" ShowBorder="false" ShowHeader="false" Layout="Region">
            <Items>
                <f:Panel runat="server" ID="panelLeftRegion" RegionPosition="Left" RegionSplit="false" EnableCollapse="true"
                    Width="420px" Title="餐台列表" ShowBorder="true" ShowHeader="true"
                    BodyPadding="2px">
                    <Items>
                        <f:Grid ID="gdTabieUsingInfo" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                            AutoScroll="true" EnableCheckBoxSelect="false" EnableCollapse="true"
                            DataKeyNames="ID" AllowSorting="false" SortField="DishesID" Height="600px"
                            SortDirection="ASC" AllowPaging="false" IsDatabasePaging="true" EnableAfterEditEvent="true">
                            <Columns>
                                <f:TemplateField Width="100px" HeaderText="台号">
                                    <ItemTemplate>
                                        <asp:Label ID="Label2" runat="server" Text='<%# GetTabieName(Eval("TabieID").ToString()) %>'></asp:Label>
                                    </ItemTemplate>
                                </f:TemplateField>
                                <f:BoundField DataField="Moneys" SortField="Moneys" Width="100px" HeaderText="总金额(元)" />
                                <f:BoundField DataField="PrePrice" SortField="PrePrice" Width="100px" HeaderText="赠送金额(元)" />
                                <f:BoundField DataField="FactPrice" SortField="FactPrice" Width="100px" HeaderText="应付金额(元)" />
                            </Columns>
                        </f:Grid>
                    </Items>
                </f:Panel>
                <f:Panel ID="Panel3" runat="server" RegionPosition="Left" RegionSplit="false" EnableCollapse="true"
                    Width="420px" ShowBorder="true" ShowHeader="true"
                    BodyPadding="2px" Title="结算信息" MarginLeft="10px">
                    <Items>
                        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" RegionPosition="Left" RegionSplit="true"
                            ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch" BoxConfigPosition="Start"
                            ShowHeader="false" Title="合并付款">
                            <Items>
