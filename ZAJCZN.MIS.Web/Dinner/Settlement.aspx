<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Settlement.aspx.cs" Inherits="ZAJCZN.MIS.Web.Settlement" %>
                            ...
                            <Rows>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:TextBox ID="tbxCashFact" Text="0.00" OnTextChanged="tbxCashFact_TextChanged" runat="server" AutoPostBack="true"></f:TextBox>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:TextBox ID="tbxWXFact" Text="0.00" OnTextChanged="tbxWXFact_TextChanged" runat="server" AutoPostBack="true"></f:TextBox>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:TextBox ID="tbxZFBFact" Text="0.00" OnTextChanged="tbxZFBFact_TextChanged" runat="server" AutoPostBack="true"></f:TextBox>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:TextBox ID="tbxCreditFact" Text="0.00" OnTextChanged="tbxCreditFact_TextChanged" runat="server" AutoPostBack="true"></f:TextBox>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:TextBox ID="tbxVipFact" Text="0.00" OnTextChanged="tbxVipFact_TextChanged" runat="server" AutoPostBack="true"></f:TextBox>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:TextBox ID="tbxGroupFact" Text="0.00" OnTextChanged="tbxGroupFact_TextChanged" runat="server" AutoPostBack="true"></f:TextBox>
