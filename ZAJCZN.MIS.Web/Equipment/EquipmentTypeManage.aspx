<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentTypeManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.EquipmentTypeManage" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" Position="Top" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" EnablePostBack="false" Text="新增商品类别">
                                </f:Button>
                    ...
                    <Columns>
                        <f:WindowField ColumnID="editField" TextAlign="Center" Icon="Pencil" ToolTip="编辑商品类别"
                            WindowID="Window1" Title="编辑商品类别" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/Equipment/EquipmentTypeEdit.aspx?id={0}"
                            Width="50px" />
                        <f:BoundField DataField="TypeName" SortField="TypeName" HeaderText="商品类别名称" Width="300px" />
                        <f:BoundField DataField="TypeClass" SortField="TypeClass" HeaderText="材料类型" Width="140px" />
