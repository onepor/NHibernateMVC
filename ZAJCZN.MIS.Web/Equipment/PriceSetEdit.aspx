<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PriceSetEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.PriceSetEdit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        <f:FormRow runat="server">
                            <Items>
                                <f:TextBox ID="txtCostName" ShowRedStar="true" LabelWidth="120px" LabelAlign="Right" runat="server" Label="口味类型名称" Required="true">
                                </f:TextBox>
                            </Items>
                        </f:FormRow>
                        <f:FormRow runat="server">
