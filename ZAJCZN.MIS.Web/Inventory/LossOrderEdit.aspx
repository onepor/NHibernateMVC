<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LossOrderEdit.aspx.cs" Inherits="ZAJCZN.MIS.Web.LossOrderEdit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch"
            BoxConfigPosition="Start" ShowHeader="false" Title="新增损耗单">
            <Items>
                <f:Panel ID="GroupPanel3" runat="server" ShowHeader="false">
                    <Items>
                        <f:Toolbar ID="Toolbar2" runat="server">
                            <Items>
                                <f:Button ID="btnReturn" OnClick="btnReturn_Click" runat="server" Icon="Delete" Text="取消损耗单">
                                </f:Button>
                ...
                <f:GroupPanel ID="GroupPanel1" runat="server" Title="损耗单基础信息">
                    <Items>
                        <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server">
                            <Items>
                                <f:FormRow>
                                    <Items>
                                        <f:Label ID="lblOrderNo" runat="server" Label="损耗单号" LabelAlign="Right"></f:Label>
                                        <f:DatePicker ID="dpStartDate" Label="报损日期" runat="server" Required="true" ShowRedStar="true"
                                            LabelAlign="Right">
                                        </f:DatePicker>
                                        <f:Label ID="lblCount" runat="server" LabelAlign="Right" Label="报损数量" Text="0"></f:Label>
                                        <f:Label ID="lblAmount" runat="server" LabelAlign="Right" Label="出库金额(元)" Text="0"></f:Label>
                                    </Items>
                                </f:FormRow>
                                <f:FormRow>
                                    <Items>
                                        <f:DropDownList ID="ddlSuplier" Label="报损人" LabelAlign="Right" DataTextField="EmployeeName"
                ...
                <f:GroupPanel ID="GroupPanel2" runat="server" Title="损耗商品信息">
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                            ...
                            <Toolbars>
                                <f:Toolbar ID="Toolbar1" runat="server">
                                    <Items>
                                        <f:Button ID="btnNew" Text="选择损耗商品" Icon="Add" EnablePostBack="false" runat="server">
                                        </f:Button>
