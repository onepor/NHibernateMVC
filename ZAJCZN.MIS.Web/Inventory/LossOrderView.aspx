<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LossOrderView.aspx.cs" Inherits="ZAJCZN.MIS.Web.LossOrderView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch"
            BoxConfigPosition="Start" ShowHeader="false" Title="查看损耗单">
            <Items>
                    ...
                    <Items>
                        <f:Toolbar ID="Toolbar2" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnReturn" OnClick="btnReturn_Click" runat="server" Icon="arrowleft" Text="返回损耗单列表">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Items>
                            ...
                            <Items>
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:Label ID="lblOrderDate" runat="server" Label="出单日期" LabelAlign="Right"></f:Label>
                                ...
                                <f:FormRow>
                                    <Items>
                                        <f:Label ID="lblUser" runat="server" Label="报损人" LabelAlign="Right"></f:Label>
                    ...
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="GoodsNumber" SortField="GoodsNumber" Width="90px" HeaderText="损耗数量" />
