<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReceiveOrderManager.aspx.cs" Inherits="ZAJCZN.MIS.Web.ReceiveOrderManager" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            ShowHeader="false" Title="领用管理">
            <Items>
                <f:Panel ID="Panel2" ShowHeader="false" ShowBorder="false" Layout="Column" runat="server">
                    <Items>
                        <f:TextBox ID="txtOrderNo" runat="server" Label="领用单号" Width="400px" LabelAlign="Right" LabelWidth="80px" EmptyText="输入领用单号或领用人查询"></f:TextBox>
                        <f:DatePicker ID="dpStartDate" LabelWidth="120px" Label="领用时间" Width="260px" runat="server" LabelAlign="Right">
                        </f:DatePicker>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnNew" runat="server" Icon="Add" OnClick="btnNew_Click" Text="新增领用单">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="OrderNO" SortField="OrderNO" Width="160px" HeaderText="领用单号" />
                        <f:BoundField DataField="OrderDate" SortField="OrderDate" Width="160px" HeaderText="领用时间" />
                        <f:BoundField DataField="UserName" SortField="UserName" Width="100px" HeaderText="领用人" />
                        ...
                        <f:LinkButtonField HeaderText="查看" TextAlign="Center" Icon="Information" ToolTip="查看领用单详情"
