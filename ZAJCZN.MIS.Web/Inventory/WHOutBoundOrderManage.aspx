<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WHOutBoundOrderManage.aspx.cs" Inherits="ZAJCZN.MIS.Web.WHOutBoundOrderManage" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Panel ID="Panel2" ShowHeader="false" ShowBorder="false" Layout="Column" runat="server">
                    <Items>
                        <f:TextBox ID="txtOrderNo" runat="server" Label="出库(业务)单号" Width="300px" LabelAlign="Right" LabelWidth="120px"></f:TextBox>
                        <f:DatePicker ID="dpStartDate" LabelWidth="120px" Label="出库起止时间" Width="260px" runat="server" LabelAlign="Right">
                        </f:DatePicker>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        <f:LinkButtonField HeaderText="查看" TextAlign="Center" Icon="Information" ToolTip="查看出库单详情"
                            CommandName="viewField" Width="80px" />
                        <f:RowNumberField TextAlign="Center" Width="35px" Hidden="true" EnablePagingNumber="true" />
                        <f:BoundField DataField="OrderNO" SortField="OrderNO" Width="200px" HeaderText="出库单号" />
                        <f:BoundField DataField="BOrderNO" SortField="BOrderNO" Width="200px" HeaderText="业务单号" />
                        <f:BoundField DataField="OrderDate" SortField="OrderDate" Width="230px" HeaderText="出库时间" />
                        <f:BoundField DataField="OrderNumber" SortField="OrderNumber" Width="100px" HeaderText="商品数量" />
                        <f:BoundField DataField="OrderAmount" SortField="OrderAmount" Width="120px" HeaderText="出库金额" Hidden="true" />
                        <f:TemplateField Width="120px" HeaderText="出库仓库">
                            <ItemTemplate>
                                <asp:Label ID="Label4" runat="server" Width="120px" Text='<%# GetWHName(Eval("WareHouseID").ToString()) %>'></asp:Label>
                            </ItemTemplate>
                        </f:TemplateField>
                        <f:BoundField DataField="Remark" SortField="Remark" Width="120px" HeaderText="出库备注" />
