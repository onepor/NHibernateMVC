<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WHStorageOrderView.aspx.cs" Inherits="ZAJCZN.MIS.Web.WHStorageOrderView" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" ShowBorder="false" Layout="VBox" BoxConfigAlign="Stretch"
            BoxConfigPosition="Start" ShowHeader="false" Title="入库单明细">
            <Items>
                    ...
                    <Items>
                        <f:Toolbar ID="Toolbar2" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnReturn" OnClick="btnReturn_Click" runat="server" Icon="arrowleft" Text="返回入库单列表">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Items>
                </f:Panel>
                <f:GroupPanel ID="GroupPanel1" runat="server" Title="入库单基础信息">
                    <Items>
                        <f:Form ID="Form2" ShowBorder="false" ShowHeader="false" runat="server">
                            <Items>
                                <f:FormRow>
                                    <Items>
                                        <f:Label ID="lblOrderNo" runat="server" Label="入库单号" LabelAlign="Right"></f:Label>
                                        <f:Label ID="lblStartDate" runat="server" LabelAlign="Right" Label="入库时间" Text="0"></f:Label>
                                ...
                                <f:FormRow>
                                    <Items>
                                        ...
                                        <f:Label ID="lblTypeName" runat="server" Label="入库类型" LabelAlign="Right"></f:Label>
                                        <f:Label ID="lblCount" runat="server" LabelAlign="Right" Label="商品数量" Text="0"></f:Label>
                                        <f:Label ID="lblAmount" runat="server" LabelAlign="Right" Label="入库金额(元)" Text="0"></f:Label>
                                    </Items>
                                </f:FormRow>
                            </Items>
                        </f:Form>
                ...
                <f:GroupPanel ID="GroupPanel2" runat="server" Title="入库商品信息">
                    <Items>
                        <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" EnableCollapse="true"
                            ...
                            <Columns>
                                ...
                                <f:BoundField DataField="GoodsNumber" SortField="GoodsNumber" Width="120px" HeaderText="入库数量" />
