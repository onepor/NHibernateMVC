<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderReceiveSelectDialog.aspx.cs" Inherits="ZAJCZN.MIS.Web.OrderReceiveSelectDialog" %>
            ...
            <Items>
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow2" runat="server">
                            <Items>
                                ...
                                <f:Label ID="lblWHInfo" runat="server" ShowLabel="false"></f:Label>
                ...
                <f:Grid ID="Grid1" ShowBorder="true" ShowHeader="false" Title="库存物品列表" runat="server"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="InventoryUnitPrice" Width="100px" HeaderText="单价(元)" />
