...
{
    public partial class OrderReceiveSelectDialog : PageBase
    {
        #region ViewPower
        ...
        private bool IsExists(int goodsID)
        {
            ...
            ReceiveOrderDetail objInfo = Core.Container.Instance.Resolve<IServiceReceiveOrderDetail>().GetEntityByFields(qryList);
