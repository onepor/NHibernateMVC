<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RPTChargeDetail.aspx.cs" Inherits="ZAJCZN.MIS.Web.RPTChargeDetail" %>
            ...
            <Items>
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="FactPrice" SortField="FactPrice" Width="200px" HeaderText="挂账金额" />
                        <f:BoundField DataField="ClearTime" SortField="ClearTime" Width="200px" HeaderText="挂账时间" />
                    </Columns>
                </f:Grid>
            </Items>
        </f:Panel>
