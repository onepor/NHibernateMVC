<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RPTIsFree.aspx.cs" Inherits="ZAJCZN.MIS.Web.RPTIsFree" %>
            ...
            <Items>
                <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:DropDownList ID="ddlIsFree" runat="server"></f:DropDownList>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Amount" SortField="Amount" Width="200px" HeaderText="免单总金额" />
