...
{
    public partial class RPTIsFreeDetail : PageBase
    {
        #region ViewPower
        ...
        protected string _FreeReason
        {
            get { return GetQueryValue("FreeReason"); }
        }
        ...
        {
            string sql = "SELECT FreeReason,FactPrice,ClearTime " +
                         "FROM tm_tabieusinginfo " +
                         "where FreeReason='" + _FreeReason + "'" + _sql +
        ...
        protected void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            if (htmls != "")
            {
                ...
                Response.AddHeader("content-disposition", "attachment; filename=免单明细报表" + DateTime.Now.ToString("yyyyMMddHHmmss") + ".xls");
        ...
        private string GetAllTableHtml()
        {
            ...
            if (ds.Tables[0].Rows.Count != 0)
            {
                ...
                sb.AppendFormat("<td style=\"text-align:center\">{0}</td>", "免单时间");
                sb.Append("</tr>");
