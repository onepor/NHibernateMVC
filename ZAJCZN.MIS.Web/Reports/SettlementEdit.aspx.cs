...
{
    public partial class SettlementEdit : PageBase
    {
        ...
        protected void btnAccept_Click(object sender, EventArgs e)
        {
            ...
            Core.Container.Instance.Resolve<IServiceSettlement>().Update(entity);
