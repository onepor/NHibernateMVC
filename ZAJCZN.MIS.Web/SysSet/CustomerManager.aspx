<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerManager.aspx.cs" Inherits="ZAJCZN.MIS.Web.CustomerManager" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px"
            ...
            <Items>
                <f:Form ID="Form2" runat="server" Height="36px" BodyPadding="5px" ShowHeader="false"
                    ...
                    <Rows>
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:TwinTriggerBox ID="ttbSearchMessage" runat="server" ShowLabel="false" EmptyText="在客户名称、电话号码中搜索"
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    EnableCheckBoxSelect="false" DataKeyNames="ID" AllowSorting="true" OnSort="Grid1_Sort" SortField="CustomerNumber"
                    ...
                    <Columns> 
                        <f:BoundField DataField="CustomerNumber" TextAlign="Center" SortField="CustomerNumber" Width="70" HeaderText="编号" />
                        <f:BoundField DataField="CustomerName" SortField="CustomerName" Width="200px" HeaderText="客户名称" />
                        <f:BoundField DataField="LinkMan" SortField="LinkMan" Width="200" HeaderText="联系人" />
                        <f:BoundField DataField="ContractPhone" SortField="ContractPhone" Width="120px" HeaderText="联系电话" />
                        ...
                        <f:WindowField ColumnID="editField" HeaderText="编辑" TextAlign="Center" Icon="Pencil" ToolTip="编辑"
                            WindowID="Window1" Title="编辑" DataIFrameUrlFields="ID" DataIFrameUrlFormatString="~/SysSet/CustomerEdit.aspx?id={0}&action=edit"
                            Width="80px" />
