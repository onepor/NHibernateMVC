<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="menu.aspx.cs" Inherits="ZAJCZN.MIS.Web.admin.menu" %>
                ...
                <f:Grid ID="Grid1" runat="server" ShowBorder="true" ShowHeader="false" EnableCheckBoxSelect="false"
                    ...
                    <Columns>
                        ...
                        <f:BoundField DataField="Name" HeaderText="菜单标题" DataSimulateTreeLevelField="TreeLevel"
                            Width="260px" />
                        <f:BoundField DataField="NavigateUrl" HeaderText="链接" Width="300px" />
                        <f:BoundField DataField="ViewPowerName" HeaderText="浏览权限" Width="200px" />
