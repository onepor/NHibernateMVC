...
namespace ZAJCZN.MIS.Web.admin
{
    public partial class menu : PageBase
    {
        ...
        {
            List<menus> menus = MenuHelper.Menus;
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            ...
            if (e.CommandName == "Delete")
            {
                ...
                qryList.Add(Expression.Eq("ParentID", menuID));
                int childCount = Core.Container.Instance.Resolve<IServiceMenus>().GetRecordCountByFields(qryList);
                ...
                Core.Container.Instance.Resolve<IServiceMenus>().Delete(menuID);
