<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="power.aspx.cs" Inherits="ZAJCZN.MIS.Web.admin.power" %>
        ...
        <f:Panel ID="Panel1" runat="server" BodyPadding="5px" 
            ...
            <Items>
                ...
                <f:Grid ID="Grid1" runat="server" BoxFlex="1" ShowBorder="true" ShowHeader="false"
                    ...
                    <Columns>
                        <f:RowNumberField />
                        <f:BoundField DataField="GroupName" SortField="GroupName" Width="220px" HeaderText="分组名称" />
                        <f:BoundField DataField="Name" SortField="Name" Width="280px" HeaderText="权限名称" />
