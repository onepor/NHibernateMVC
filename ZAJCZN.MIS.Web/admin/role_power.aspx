<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_power.aspx.cs" Inherits="ZAJCZN.MIS.Web.admin.role_power" %>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <f:Region ID="Region2" ShowBorder="false" ShowHeader="false" Position="Center" Layout="Fit" BodyPadding="5px 5px 5px 0" runat="server">
                    <Items>
                        <f:Grid ID="Grid2" runat="server" ShowBorder="true" ShowHeader="false" EnableMultiSelect="true"
                            EnableCheckBoxSelect="false" DataKeyNames="ModuleId,ModuleName" AllowSorting="true"
                            OnSort="Grid2_Sort" OnRowDataBound="Grid2_RowDataBound" SortField="GroupName"
                            ...
                            <Columns>
                                <f:RowNumberField></f:RowNumberField>
                                <f:BoundField DataField="GroupName" SortField="GroupName" HeaderText="分组名称" Width="160px"></f:BoundField>
                                <f:TemplateField ExpandUnusedSpace="true" ColumnID="Powers" HeaderText="权限列表">
                                    <ItemTemplate>
                                        <asp:CheckBoxList ID="ddlPowers" CssClass="powers" RepeatLayout="Table"
                                            RepeatDirection="Vertical" runat="server" RepeatColumns="6">
                                        </asp:CheckBoxList>
                                    </ItemTemplate>
                                </f:TemplateField>
                            </Columns>
