<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user.aspx.cs" Inherits="ZAJCZN.MIS.Web.admin.user" %>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnSendMsg" runat="server" Icon="ShieldGo" OnClick="btnSendMsg_Click" Text="发送消息">
                                </f:Button>
                            </Items>
                        </f:Toolbar>
                    </Toolbars>
