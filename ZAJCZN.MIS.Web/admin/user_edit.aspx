<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="user_edit.aspx.cs" Inherits="ZAJCZN.MIS.Web.admin.user_edit" %>
                ...
                <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false" runat="server" BodyPadding="10px"
                    ...
                    <Rows>
                        ...
                        <f:FormRow ID="FormRow1" runat="server">
                            <Items>
                                <f:TextBox ID="tbxEmail" runat="server" Label="邮箱" RegexPattern="EMAIL">
                                </f:TextBox>
