<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="ZAJCZN.MIS.Web._default" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:Window ID="Window1" runat="server" IsModal="true" Hidden="false" EnableClose="false"
            ...
            <Items>
                <f:Image ID="imageLogin" ImageUrl="~/res/images/login/logo.png" runat="server"
            ...
            <Toolbars>
                <f:Toolbar runat="server" Position="Bottom" ToolbarAlign="Right">
                    <Items>
                        ...
                        <f:ToolbarFill runat="server" ID="ToolbarFill1"></f:ToolbarFill>
